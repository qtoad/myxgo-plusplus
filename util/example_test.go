...
//	rc, err := util.HttpGet(&http.Client{}, "http://gowalker.org", nil)
//	if err != nil {
//		return nil, err
//	}
...
//	p, err := util.HttpGetBytes(&http.Client{}, "http://gowalker.org", nil)
//	return p, err
//}
//
//func ExampleHttpGetJSON() interface{} {
//	j := util.HttpGetJSON(&http.Client{}, "http://gowalker.org", nil)
//	return j
//}
